...
namespace ft {
	...
	class map {
		public:
			...
			typedef typename ft::bidirectionnal_iterator<ft::Node<value_type> > 				iterator;
			typedef typename ft::bidirectionnal_iterator<const ft::Node<value_type> >			const_iterator;
